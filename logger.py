...
class Tacotron2Logger(SummaryWriter):
    ...
    def log_validation(self, reduced_loss, model, y, y_pred, iteration):
        ...
        _, mel_outs_l, gate_outs_l, aligns_l, _ = outs_left
        _, mel_outs_r, gate_outs_r, aligns_r, _ = outs_right
        ...
        self.add_image(
            ...
            plot_spectrogram_to_numpy(
                mel_targets_left[idx].data.cpu().numpy()
            ),
            iteration,
            dataformats="HWC",
        )
        ...
        self.add_image(
            ...
            plot_spectrogram_to_numpy(
                mel_targets_right[idx].data.cpu().numpy()
            ),
            iteration,
            dataformats="HWC",
        )
